...
export const loans: LoanData[] = [
  {
    ...
    minAmount: '₹10 Lakh',
    features: [
      { icon: '🏠', title: 'Low Interest Rates', desc: 'Competitive rates starting at 8.5% p.a. to keep your EMIs affordable' },
      { icon: '📅', title: 'High Tenure', desc: 'Repay comfortably with loan tenures of up to 30 years' },
  ...
  },
  {
    ...
    minAmount: '₹5 Lakh',
    features: [
      { icon: '🏢', title: 'High Loan Amount', desc: 'Borrow up to ₹10 Crore or up to 70% of your property value' },
      { icon: '📉', title: 'Lower Interest Rate', desc: 'Secured loan means lower interest rates compared to personal loans' },
      { icon: '⏳', title: 'Long Tenure', desc: 'Repay the loan over up to 15 years with ease' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '📊', title: 'Flexible Repayment', desc: 'Choose repayment tenure from 12 to 84 months based on your cash flow' },
  ...
  },
  {
    ...
    minAmount: '₹1 Lakh',
    features: [
      { icon: '🚗', title: 'Low Interest Rates', desc: 'Among the lowest car loan rates in the market starting at just 7.5% p.a.' },
      ...
      { icon: '📅', title: 'Flexible Tenure', desc: 'Choose repayment period from 12 to 84 months to suit your budget' },
